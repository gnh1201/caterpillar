...
You can connect all physical and logical channels with communication capabilities to the web! It supports the implementation of extensions for Connectors (e.g., Web Archive, Serial), Filters, and RPC (JSON-RPC 2.0) methods.
